...
class Jira {
  ...
  closeIssue(issueKey) {
    ...
    return new Promise(function(resolve, reject) {
      // Send close transition command to the JIRA API.
      self.jiraClient.issue.transitionIssue(
        {
          'issueKey': issueKey,
          'transition': {
            'id': '41'
  ...
  deleteIssue(issueKey) {
    ...
    return new Promise(function(resolve, reject) {
      // Send close transition command to the JIRA API.
      self.jiraClient.issue.deleteIssue(
        {
          'issueKey': issueKey,
          '?deleteSubtasks': 'true'
        },
  ...
  getTrans(issueKey) {
    ...
    return new Promise(function(resolve, reject) {
      return self.jiraClient.issue.getTransitions({
          issueKey: issueKey
  ...
  transIssue(issueKey, transID) {
    var self = this

    var transID = transID.toString();
