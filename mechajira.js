...
program
  ...
  .command('find-children [options] <parent>', 'Find all children of a parent issue.').alias('fc')
  .command('edit-children [options] <file> <parent>', 'Edit all children of a parent with fields set in a YAML file.').alias('ec')
  .parse(process.argv);
